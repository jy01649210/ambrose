...
//  }
  ...
  private WorkflowIndexReadService workflowIndexReadService = new InMemoryStatsService();
  private StatsReadService<Job> statsReadService = new InMemoryStatsService();
